<template>
    <footer class="footer">
        ...
        <ul class="social-icon">
            ...
            <li class="social-icon__item">
                <a href="https://www.linkedin.com/in/jotacarvalho-5568a01a4/" class="social-icon__link" target=_blank>
            ...
            <li class="social-icon__item">
                <a href="https://github.com/jotacarvalh0" class="social-icon__link" target=_blank>
